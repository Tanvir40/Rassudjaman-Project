   ...
   <main>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-12 text-white"><ul class="breadcrumb"><li class="breadcrumb-item"><a href="../../index.html">Home</a><span class="divider">&nbsp;</span></li><li class="breadcrumb-item"><a href="../../post.html">All Post</a><span class="divider">&nbsp;</span></li><li class="breadcrumb-item">BookList...<span class="divider-last">&nbsp;</span></li></ul>  </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="blog-list-simple-text">
                ...
                <p><strong>List of Books By Professor Dr. Mohammad Rashidul Hassan published till date</strong></p>
...
<td><img src="{{asset('frontend/books')}}/{{$book->book_image}}
"><a href="" border="0" width="140" height="310" />{{$book->book_name}}</a>
</tr>
@endforeach
