                        ...
                        <div class="col-lg-12">
                                    ...
                                    <form action="{{route('covid.save')}}" method="post">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <label for="exampleInputEmail1">Covid Content Update</label>
                                            <textarea  class="form-control" id="exampleInputEmail1" name="text" id="" cols="30" rows="10">{{$covid->text}}</textarea>
                                            </div>
                                            @endforeach
                                        </div>
