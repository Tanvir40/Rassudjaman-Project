            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <h2>Add <b>ramadan life-style video </b></h2>
                        </div>
                    ...
                    <div class="col-md-10 m-auto">
                        ...
                        <form action="{{route('ramadanlifestyle.save')}}" method="post">
                            @csrf
                            <div class="card-body">
                    ...
                    <div class="col-sm-12">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                @foreach ($ramadanlifestyle as $key=>$video)
                                <tr>
                                        ...
                                        <button type="button" name="{{route('ramadanlifestyle.delete', $video->id)}}" class="delete btn btn-danger shadow btn-xs sharp mr-1"><i class="fa fa-trash"></i></button>
                                        </td>
                                </tr>
                                @endforeach
                            </tbody>
