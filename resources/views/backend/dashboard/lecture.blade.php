			...
			<table class="table table-striped table-hover">
				<thead>
					<tr>
						...
						<th>Sl.</th>
						<th>lecture_title_en</th>
						<th>lecture_title_bn</th>
						<th>lecture_details_part_en</th>
						<th>lecture_details_part_bn</th>
				...
				<tbody id="tasktablebody">
					...
					@foreach($lecture as $lecture)
						...
						<td>{{$lecture->id}}</td>
						<td>{{$lecture->lecture_title_en}}</td>
						<td>{{$lecture->lecture_title_bn}}</td>
						<td>{{$lecture->lecture_details_part_en}}</td>
						<td>{{$lecture->lecture_details_part_bn}}</td>
						
						
						<td>
							<a href="{{asset('lecture/editdata/'.$lecture->id)}}" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
							<a href="{{asset('lecture/deletedata/'.$lecture->id)}}" onclick="return myConfirm();" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
						</td>
					</tr>
					@endforeach
...
<div id="addEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form name="" action="{{asset('/lecture/store')}}" method="post">
				@csrf
				...
				<div id="createTaskMessage"></div>					
					<div class="form-group">
						<label>Lecture  key</label>
						<input type="text" name="lecture_key" class="form-control" required>
					</div>
					<div class="form-group">
						<label>Lecture Title En</label>
						<input type="text" name="lecture_title_en" class="form-control" required>
					</div>
					<div class="form-group">
						<label>Lecture Title Bn</label>
						<input type="text" name="lecture_title_bn" class="form-control" required>
					</div>
					
					
					<div class="form-group">
						<label>Lecture Details En</label>
						<textarea  name="lecture_details_part_en" rows="4" cols="40"></textarea>
					</div>

					<div class="form-group">
						<label>Lecture Details Bn</label>
						<textarea  name="lecture_details_part_bn" rows="4" cols="40"></textarea>
					</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<form>
				  ...
				  @foreach($lecturedit as $lecturedit)
				...
				<div class="modal-body">					
					<div class="form-group">
						<label>lecture_title_en</label>
						<input type="text" value="{{$lecturedit->lecture_title_en}}" class="form-control" required>
					</div>
					<div class="form-group">
						<label>Email</label>
