		...
		<div class="table-wrapper">
			...
			<table class="table table-striped table-hover">
				...
				<tbody id="tasktablebody">
					<tr>
					@foreach($allachievement as $allachievements)
						<td>
							<span class="custom-checkbox">
						...
						<td>{{$allachievements->id}}</td>
						<td>{{$allachievements->title_en}}</td>
						<td>{{$allachievements->title_bn}}</td>
						<td>{{$allachievements->brief_en}}</td>
						<td>{{$allachievements->brief_bn}}</td>
						
						
						
						<td>
							<a href="{{asset('achievements/editdata/'.$allachievements->id)}}" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
							<a href="{{asset('lecture/deletedata/'.$allachievements->id)}}" onclick="return myConfirm();" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
						</td>
					</tr>
					@endforeach
