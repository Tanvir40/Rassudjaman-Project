	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>Students <b>Registration</b></h2>
					</div>
					<div class="col-sm-6">
				...
				<tbody id="tasktablebody">
					...
					@foreach($task as $task)
						...
						<td>
							...
							<a href="{{asset('task/deletedata/'.$task->id)}}" onclick="return myConfirm();" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
						</td>
					</tr>
					@endforeach
